...
namespace FTPCloudDisk
{
    public partial class Login : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.LabelPw.BackColor = Color.FromArgb(100, 255, 255, 255);
        ...
        private void Delegate_FindNone(bool tf)
        {
            ...
            else
            {
                try
                {
                    if (tf)
                    {
                        this.LoginB.Enabled = true;
                    }
                    else
                    {
                        this.LoginB.Enabled = false;
                    }
                }
                catch (Exception ex)
                {
        ...
        private void WriteData(string path, string Waiting)
        {
            //把文件打开转移到函数外否则不可递归
        ...
        private void RegiB_Click(object sender, EventArgs e)
        {
            Register RegFrom = new Register();
            RegFrom.Show();
        }
